...
<script type="text/javascript" src="http://emreceyhan.net/js/jquery-2.1.3.min.js"></script>

<title>Arabesk Şarkılar</title>
<style type="text/css">
#headerkap
{
	display:flex;
...
<div class="icerikkap sarkilar">Arabesk Şarkılar<br /><br />

<?php

$sarki="select sanatci_adi,sarki_adi from sarki where tur_id=3";
...
while($statement->fetch())
{
	...
	echo '<div style="float:left;margin-left:33px;width:175px;margin-bottom:50px;border:1px solid #CCC">';
	 ...
	 echo '<a>'.$a." - ".$b."</a>";
	  ...
	  echo '<center>'.'<a style="float:left" class="a" href="arabesk.php?s=mp3/arabesk/'.$sarkiadi.'">Dinle</a>'.'&nbsp;'.'<a class="b" style="float:right" target="_blank" href="mp3/arabesk/'.$sarkiadi.'">İndir</a>'.'</center>';
	  echo "</div>";
	  echo '</div>';
