...
$sarkiyol = $_POST["link"];
$tur = $_POST["turno"];
if($sarkiadi!=""&&$sanatci!=""&&$sarkiyol!=""&&$tur!="")
{

$sql = "insert into sarki(sarki_adi,sanatci_adi,sarkilink,tur_id) values('$sarkiadi','$sanatci','$sarkiyol','$tur')";
...
?>
  ...
  <form method="post" action="">
    <div class="form-group">
      <label for="email">Şarkı Adı</label>
      <input type="text" class="form-control" id="email" name="sarkiadi">
    </div>
    <div class="form-group">
      <label for="a">Sanatçı Adı</label>
      <input type="text" class="form-control" id="a" name="sanatciadi">
    </div>
     <div class="form-group">
      <label for="b">Şarkı Yolu</label>
      <input type="text" class="form-control" id="b" name="link">
    </div>
    <div class="form-group">
      <label for="c">Tür No</label>
      <input type="text" class="form-control" id="c" name="turno">
    </div>
