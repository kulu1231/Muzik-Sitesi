...
<div class="icerikkap sarkilar">Türküler<br /><br />
<?php

$sarki="select sanatci_adi,sarki_adi from sarki where tur_id=4";
...
while($statement->fetch())
{
	...
	echo '<div style="float:left;margin-left:33px;width:175px;margin-bottom:50px;border:1px solid #CCC">';
	 ...
	 echo '<a>'.$a." - ".$b."</a>";
	  ...
	  echo '<center>'.'<a style="float:left" class="a" href="turku.php?s=mp3/turku/'.$sarkiadi.'">Dinle</a>'.'&nbsp;'.'<a class="b" style="float:right" target="_blank" href="mp3/turku/'.$sarkiadi.'">İndir</a>'.'</center>';
	  echo "</div>";
	  echo '</div>';
